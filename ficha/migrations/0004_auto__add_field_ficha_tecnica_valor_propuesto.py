...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ficha_Tecnica.valor_propuesto'
        db.add_column('ficha_ficha_tecnica', 'valor_propuesto',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ficha_Tecnica.valor_propuesto'
        db.delete_column('ficha_ficha_tecnica', 'valor_propuesto')
