...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ficha_Tecnica.observaciones'
        db.add_column('ficha_ficha_tecnica', 'observaciones',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ficha_Tecnica.observaciones'
        db.delete_column('ficha_ficha_tecnica', 'observaciones')
