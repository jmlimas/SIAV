...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigacion_Mercado.unitario_0'
        db.add_column('ficha_investigacion_mercado', 'unitario_0',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investigacion_Mercado.unitario_0'
        db.delete_column('ficha_investigacion_mercado', 'unitario_0')
