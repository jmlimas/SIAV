...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ficha_Tecnica.folio_2'
        db.add_column('ficha_ficha_tecnica', 'folio_2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ficha_Tecnica.municipio'
        db.add_column('ficha_ficha_tecnica', 'municipio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=986, to=orm['app.Municipio']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ficha_Tecnica.folio_2'
        db.delete_column('ficha_ficha_tecnica', 'folio_2')

        # Deleting field 'Ficha_Tecnica.municipio'
        db.delete_column('ficha_ficha_tecnica', 'municipio_id')
    ...
    models = {
        ...
        'ficha.ficha_tecnica': {
            ...
            'factor': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'folio': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'folio_2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'valor_propuesto': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
