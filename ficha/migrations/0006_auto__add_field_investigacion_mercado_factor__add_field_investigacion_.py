...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigacion_Mercado.factor'
        db.add_column('ficha_investigacion_mercado', 'factor',
        ...
        # Adding field 'Ficha_Tecnica.factor'
        db.add_column('ficha_ficha_tecnica', 'factor',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investigacion_Mercado.factor'
        db.delete_column('ficha_investigacion_mercado', 'factor')
        ...
        # Deleting field 'Ficha_Tecnica.factor'
        db.delete_column('ficha_ficha_tecnica', 'factor')
