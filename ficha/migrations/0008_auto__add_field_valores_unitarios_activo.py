...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Valores_Unitarios.activo'
        db.add_column('ficha_valores_unitarios', 'activo',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Valores_Unitarios.activo'
        db.delete_column('ficha_valores_unitarios', 'activo')
