...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>helper &mdash; django-crispy-forms 1.0.0 documentation</title>
...
<div class="viewcode-block" id="FormHelpersException"><a class="viewcode-back" href="../api_helpers.html#helper.FormHelpersException">[docs]</a><span class="k">class</span> <span class="nc">FormHelpersException</span><span class="p">(</span><span class="ne">Exception</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot; </span>
...
<div class="viewcode-block" id="FormHelper"><a class="viewcode-back" href="../api_helpers.html#helper.FormHelper">[docs]</a><span class="k">class</span> <span class="nc">FormHelper</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">get_form_method</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_form_method</span>
    
    <span class="k">def</span> <span class="nf">set_form_method</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">method</span><span class="p">):</span>
...
<span class="s">                    form_method helper attribute&#39;</span><span class="p">)</span>
    ...
    <span class="c"># we set properties the old way because we want to support pre-2.6 python</span>
    ...
    <span class="k">def</span> <span class="nf">get_form_action</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">set_form_action</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">action</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">get_form_style</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">set_form_style</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">style</span><span class="p">):</span>
...
<span class="s">                    form_style helper attribute&#39;</span><span class="p">)</span>
    ...
    <span class="k">def</span> <span class="nf">add_input</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">input_object</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">add_layout</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">layout</span><span class="p">):</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">layout</span> <span class="o">=</span> <span class="n">layout</span>
    
<div class="viewcode-block" id="FormHelper.render_layout"><a class="viewcode-back" href="../api_helpers.html#helper.FormHelper.render_layout">[docs]</a>    <span class="k">def</span> <span class="nf">render_layout</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">form</span><span class="p">,</span> <span class="n">context</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="k">if</span> <span class="nb">getattr</span><span class="p">(</span><span class="n">form</span><span class="p">,</span> <span class="s">&#39;Meta&#39;</span><span class="p">,</span> <span class="bp">None</span><span class="p">):</span>
            <span class="n">fields</span> <span class="o">=</span> <span class="nb">set</span><span class="p">(</span><span class="nb">getattr</span><span class="p">(</span><span class="n">form</span><span class="o">.</span><span class="n">Meta</span><span class="p">,</span> <span class="s">&#39;fields&#39;</span><span class="p">,</span> <span class="p">[]))</span>
...
<div class="viewcode-block" id="FormHelper.get_attributes"><a class="viewcode-back" href="../api_helpers.html#helper.FormHelper.get_attributes">[docs]</a>    <span class="k">def</span> <span class="nf">get_attributes</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
